...
Clear and consistent terminology is essential to avoid misinterpretation and miscommunication. This section introduces key terms that will be used throughout the learning line. Sect. 2.1 defines terminology used in connection with measurement and observation and explains how measurements, observations, and data are distinguished. Sect. 2.2 introduces the concept of uncertainty, with an emphasis on measurement uncertainty. Here we explain why all measurements are inherently uncertain and define the main terms used to quantify and analyse uncertainty.
