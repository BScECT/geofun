...
|----|----|
| 
$${A\_{f} = \pi}{{({\frac{1}{2}R\beta})}^{2} = \frac{\pi R^{2}\beta^{2}}{4}}.$$ | (1.3) |
...
|----|----|
| 
$${E\_{r} = E\_{t}}{\sigma = \frac{4P\_{t}}{\pi R^{2}\beta^{2}}}\frac{\sigma}{4\pi R^{2}}.$$ | (1.5) |
...
|----|----|
| 
$${A\_{r} = \pi}{{({\frac{1}{2}D\_{r}})}^{2} = \frac{\pi D\_{r}^{2}}{4}}.$$ | (1.6) |
...
|----|----|
| 
$${P\_{r} = \frac{4P\_{t}}{\pi R^{2}\beta^{2}}}\frac{\sigma}{4\pi R^{2}}{\frac{\pi D\_{r}^{2}}{4} = \frac{P\_{t}\sigma D\_{r}^{2}}{4\pi R^{4}\beta^{2}}}.$$ | (1.7) |
...
|                                                                        |
|------------------------------------------------------------------------|
| <img src="Pictures/1000000100000571000003199CE0E216C0164B97.png"       
 style="width:6.5984in;height:3.7563in" />                               |
| Fig. 8: The solar irradiance spectrum. Taken from Rieger et al. (2025) |
...
|----|----|
| 
$${P\_{r} = \frac{P\_{t}\sigma D\_{r}^{2}}{4\pi R^{4}\beta^{2}}}\eta\_{\mathit{sys}}{\eta\_{\mathit{atm}} + P\_{b}}.$$ | (1.8) |
