(2:statistical_tables)=
# More statistical tables
...
```{table} Critical values for standard normal distribution based on the significance level $\alpha$.
:widths: auto
:align: center

| $\boldsymbol{\alpha}$ | **25%** | **20%** | **15%**  | **10%** | **5%** | **2.5%** | **1%** | **0.5%** | **0.25%** | **0.1%** | **0.05%** |
| --- | ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:|
...
```{table} Critical values for Student's $t$-distribution based on the significance level $\alpha$ and the degrees of freedom $\nu$.
:widths: auto
:align: center

| | | | | | | $\boldsymbol{\alpha}$ | | | | | |
| --- | ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:| ---:|
| **One-sided** | **25%** | **20%** | **15%** | **10%** | **5%** | **2.5%** | **1%** | **0.5%** | **0.25%** | **0.1%** | **0.05%** |
| **Two-sided** | **50%** | **40%** | **30%** | **20%** | **10%** | **5%** | **2%** | **1%** | **0.5%** | **0.2%** | **0.1%** |
| $\boldsymbol{\nu}$ | | | | | | | | | | | |
...
| $\boldsymbol{\infty}$ | 0.674 | 0.842 | 1.036 | 1.282 | 1.645 | 1.960 | 2.326 | 2.576 | 2.807 | 3.090 | 3.291 |
| **One-sided** | **25%** | **20%** | **15%** | **10%** | **5%** | **2.5%** | **1%** | **0.5%** | **0.25%** | **0.1%** | **0.05%** |
| **Two-sided** | **50%** | **40%** | **30%** | **20%** | **10%** | **5%** | **2%** | **1%** | **0.5%** | **0.2%** | **0.1%** |
```
